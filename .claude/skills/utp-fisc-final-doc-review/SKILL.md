...
- Si Erick envía un PDF/DOCX de tesina/informe final y pide “revisa”, “revísalo”, “revisa esta tesina” o equivalente, asumir que espera un documento de revisión entregable, no solo comentarios en chat. Después de revisar, cargar `utp-fisc-review-pdf`, generar el PDF académico con logos UTP/FISC y entregarlo con `MEDIA:/ruta/al/pdf`. Puede acompañarse con resumen breve en chat, pero el entregable principal debe ser el PDF.
...
11. Entregar correcciones priorizadas y texto sugerido cuando sea útil. Si se generará PDF de revisión, usar `utp-fisc-review-pdf` con `document_type: "Informe final"`, y para calificación final usar un título tipo `Calificación de Informe Final UTP/FISC`.
