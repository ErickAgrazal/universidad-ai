...
- **A10 (`10. Proyecto individual: Juego de Damas con IA A*`)**: publicada en ambas clases el 2026-06-11. Due **Vie Jun 12** 11:59 PM, cierre (late) Sáb Jun 13 11:59 PM, 100 pts. Mismo stack que A9 + microservicio Bun con A* puro (criterio de mayor peso, 25 pts), login/ranking, pago en modo prueba, tests. Sin rúbrica Teams (lección A9); puntos por criterio en las instrucciones. Fuente: `submissions/asignacion-10-damas-astar/`.
- **Próximo proyecto (A12, sin publicar)**: servidor MCP sobre el comercio electrónico del Parcial #2, integrado en Claude Code (.mcp.json) y ChatGPT (app/connector con Streamable HTTP). Base documental publicada el 2026-06-12 en Class Materials/modulo extra de ambos salones: `materials/modulos/MODULO_EXTRA_AGENTES_DESARROLLO_IA/MODULO_EXTRA_MCP_PROYECTOS_JUNIO_2026.pdf` (generado con `scripts/build_modulo_extra_mcp.py`). El enunciado formal en Teams está pendiente.
