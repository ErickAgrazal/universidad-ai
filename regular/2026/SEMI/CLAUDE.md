...
- **Próximo proyecto (A13, sin publicar — antes rotulado A12)**: servidor MCP sobre el comercio electrónico del Parcial #2, integrado en Claude Code (.mcp.json) y ChatGPT (app/connector con Streamable HTTP). Base documental publicada el 2026-06-12 en Class Materials/modulo extra de ambos salones: `materials/modulos/MODULO_EXTRA_AGENTES_DESARROLLO_IA/MODULO_EXTRA_MCP_PROYECTOS_JUNIO_2026.pdf` (generado con `scripts/build_modulo_extra_mcp.py`). El enunciado formal en Teams está pendiente. **Nota**: el número 12 ya se usó para el laboratorio MCP, así que este proyecto será A13.
